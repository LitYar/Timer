...
document.addEventListener("DOMContentLoaded", function() {
    const days = document.querySelectorAll(".days"), hours = document.querySelectorAll(".hours"), minuts = document.querySelectorAll(".minuts"), seconds = document.querySelectorAll(".seconds"), cardUp = document.querySelectorAll(".up"), cardDown = document.querySelectorAll(".down"), numUp = document.querySelectorAll(".num-up"), numDown = document.querySelectorAll(".num-down"), boxCard = document.querySelectorAll(".timer-box-card");
    const countDownDate = new Date("10, 5, 2022").getTime();
    let interval = setInterval(function() {
        const now = new Date().getTime();
        const distance = countDownDate - now;
        let d = Math.floor(distance / 86400000);
        let h = Math.floor(distance % 86400000 / 3600000);
...
},{}]},["ShInH","8lqZg"], "8lqZg", "parcelRequireb9d2")
